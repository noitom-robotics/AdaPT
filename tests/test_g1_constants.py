...
def test_g1_entity_creation(g1_entity) -> None:
  # 27-DoF racket XML: waist pitch/roll are welded, not hinged.
  assert g1_entity.num_actuators == 27
  assert g1_entity.num_joints == 27
...
def test_g1_actuators_configured_correctly(g1_model):
  ...
  All 27 G1 actuators should have ctrllimited=False (allowing setpoints beyond
