...
def compute_yaw_aligned_root_relative_mpkpe(command: MotionCommand) -> torch.Tensor:
  """Root-relative MPKPE with anchor yaw alignment (same convention as MPKPE)."""
...
def compute_root_relative_mpkpe(command: MotionCommand) -> torch.Tensor:
  ...
  No orientation normalization; use :func:`compute_yaw_aligned_root_relative_mpkpe` for yaw alignment.
  """
