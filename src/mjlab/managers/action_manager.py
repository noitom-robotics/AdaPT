...
if TYPE_CHECKING:
  ...
  # Runtime placeholder so ``get_type_hints`` (e.g. tyro) can resolve annotations without
  # importing ``ManagerBasedRlEnv`` during the ``manager_based_rl_env`` import cycle.
